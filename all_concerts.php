...
echo "<h1><tr><td>" . "Artist" . "</td><td>" . "Genre" . "</td><td>" . "Date" . "</td></tr></h1>";
while($row = mysqli_fetch_array($result)){   //Creates a loop to loop through results
echo "<tr><td>" . $row['artist'] . "</td><td>" . $row['genre'] . "</td><td>" . $row['date_time'] . "</td></tr>";  //$row['index'] the index here is a field name
}
